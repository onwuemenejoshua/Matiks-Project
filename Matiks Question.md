...
Page 2 — Breakdowns (Device / Segment / Game Mode)



1. Bar chart: Revenue by Device\_Type
2. Bar chart: Revenue by Preferred\_Game\_Mode
3. Bar chart: Revenue by Game\_Title
4. Bar chart: Users \& Revenue by Subscription\_Tier
5. Bar chart: Revenue by Country (top 10)
6. Matrix: Device\_Type × Subscription\_Tier revenue cross-tab
7. Slicers: Device\_Type, Subscription\_Tier, Game\_Title, Country



Page 3 — Behavioral Patterns \& Engagement



1. KPI cards: Avg Sessions per User, Avg Session Duration, Avg Hours Played
2. Histogram: Total\_Play\_Sessions distribution (usage frequency)
3. Histogram: Avg\_Session\_Duration\_Min distribution (short session users)
4. Scatter: Sessions vs Revenue
5. Bar chart: Achievement\_Score / Rank\_Tier vs avg Revenue
...
Page 5 — High-Value Users \& Cohorts
